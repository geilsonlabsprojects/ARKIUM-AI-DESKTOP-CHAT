...
import {
  Send, Square, Paperclip, Globe, Bot, ChevronDown, X, File,
} from "lucide-react";
...
interface ChatInputProps {
  onSend: (message: string, attachments: Attachment[], useSearch: boolean, useAgent: boolean) => void;
  onStop?: () => void;
        ...
        filters: [
          {
            ...
            extensions: ["txt", "md", "json", "yaml", "yml", "js", "ts", "tsx", "jsx",
                         "py", "rs", "java", "c", "cpp", "h", "csv", "html", "css", "sh", "bat"],
          },
        ],
      });
    ...
    <div className="p-3 border-t border-border-1 bg-surface-1">
      ...
      <div className="flex flex-col bg-surface-2 border border-border-1 focus-within:border-arkium-500/50 rounded-xl transition-colors">
        <textarea
          ...
          rows={1}
          className={clsx(
            "flex-1 px-4 pt-3 pb-1 bg-transparent text-sm text-zinc-100 placeholder-zinc-600",
        ...
        <div className="flex items-center gap-1 px-3 pb-2">
          ...
          <div className="relative ml-auto">
            <button
              ...
              className="flex items-center gap-1.5 px-2 py-1 text-xs text-zinc-400 hover:text-zinc-200 hover:bg-surface-3 rounded-lg transition-colors max-w-36 truncate"
            >
                  ...
                  models.map((m) => (
                    <button
                      ...
                      className={clsx(
                        ...
                        aiSettings.defaultModel === m.name
                          ? "text-arkium-300"
                          : "text-zinc-300"
                      )}
                    >
